...
<div class="container d-flex justify-content-center mt-3">
    <div class="w-75">
        ...
        <form method="post" action="{{ route('carts.destroy') }}" class="d-flex justify-content-end mt-3">
            ...
            <a href="{{ route('products.index') }}" class="btn samuraimart-favorite-button boder-dark text-dark mr-3">
                買い物を続ける
            </a>
            @if($total > 0)
            <div class="btn samuraimart-submit-button" data-bs-toggle="modal" data-bs-target="#buy-confilm-modal">購入を確定する</div>
            @else
            <div class="btn samuraimart-submit-button disabled" data-bs-toggle="modal" data-bs-target="#buy-confilm-modal">購入を確定する</div>
            @endif

            <div class="modal fade" id="buy-confilm-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
