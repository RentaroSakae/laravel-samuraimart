        ...
        <div class="row">
            ...
            <div class="col-md-3 d-flex align-items-center justify-content-end">
               <form method="POST" action="{{ route('carts.store') }}" class="m-3 align-items-end">
                ...
                <input type="hidden" name="price" value="{{ App\ModelsProduct::find($fav->favoriteable_id)->price }}">
                <input type="hidden" name="image" value="{{App\ModelsProduct::find($fav->favoriteable_id)->image}}">
                <input type="hidden" name="carriage" value="{{App\ModelsProduct::find($fav->favoriteable_id)->carriage_flag}}">
